...
import { ACCOUNT_CURRENCY_KINDS, ACCOUNT_TYPES, VALUE_KINDS } from '../../src/ledger/accountCatalog.js'
import { ACCOUNT_OPENING_DIRECTIONS, COUNTERPARTY_ACCOUNT_KINDS, accountOpeningAmounts, emptyAccountDraft } from '../../src/ledger/accountConfig.js'
import { buildCounterpartyAccountBundle, buildCounterpartyOpeningMovements } from '../../src/ledger/counterpartyAccounts.js'
import { createEmptyAdreemState, createFallbackLedgerState } from '../../src/ledger/ledgerState.js'
...
async function telegramMovementFor(draft, initialState = createFallbackLedgerState()) {
...
describe('telegram and web movement parity', () => {
  ...
  it('posts a USD transfer with the same compatible-account effect as core/web', async () => {
    const state = {
      ...
      accounts: [
        ...createFallbackLedgerState().accounts,
        {
          id: 'usd-vault',
          ownerName: 'أنا',
