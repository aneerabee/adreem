...
مفتاح أسعار «محفظتي» يبقى على الخادم فقط. إذا لم تضبط `TWELVE_DATA_API_KEY` يستخدم الخادم وصول المزود التجريبي لتحديث الأدوات المدعومة، ولا تُمسح آخر أسعار مؤكدة عند غياب أي سعر.
