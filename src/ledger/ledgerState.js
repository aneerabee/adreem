...
export function normalizeLedgerState(state, fallbackState = createEmptyAdreemState()) {
  ...
  return {
    ...
    investmentPlatforms: normalizeList(safeState.investmentPlatforms || fallbackState.investmentPlatforms),
    investmentHoldings: normalizeList(safeState.investmentHoldings || fallbackState.investmentHoldings),
    investmentTrades: normalizeList(safeState.investmentTrades || fallbackState.investmentTrades),
    investmentTransfers: normalizeList(safeState.investmentTransfers || fallbackState.investmentTransfers),
...
export function mergeLedgerStates(localState, remoteState, fallbackState = createEmptyAdreemState()) {
  ...
  return {
    ...
    investmentPlatforms: mergeRecordsById(local.investmentPlatforms, remote.investmentPlatforms),
    investmentHoldings: mergeRecordsById(local.investmentHoldings, remote.investmentHoldings),
    investmentTrades: mergeRecordsById(local.investmentTrades, remote.investmentTrades),
    investmentTransfers: mergeRecordsById(local.investmentTransfers, remote.investmentTransfers),
