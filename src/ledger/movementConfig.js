...
export const movementLabels = {
  ...
  [MOVEMENT_TYPES.USD_SALE]: 'بيع USD',
  [MOVEMENT_TYPES.USD_PURCHASE]: 'شراء USD',
...
export const movementTypeOptions = [
  ...
  },
  {
    ...
    label: 'بيع USD',
    detail: 'USD يخرج وLYD يدخل',
    tone: 'sale',
  },
  {
    type: MOVEMENT_TYPES.USD_PURCHASE,
    label: 'شراء USD',
    detail: 'LYD يخرج وUSD يدخل',
    tone: 'purchase',
  },
  {
...
export const movementConfigs = {
  ...
  [MOVEMENT_TYPES.TRUCK_INCOME]: {
    ...
    routeTitle: 'الدخل',
    noteLabel: 'تفصيل الدخل',
    notePlaceholder: 'وصف مختصر للدخل',
  },
  [MOVEMENT_TYPES.USD_SALE]: {
    amountLabel: 'كم USD بعت؟',
    currency: CURRENCIES.USD,
    currencyText: 'USD',
    currencyLocked: true,
    needsDestination: true,
    needsRate: true,
    rateLabel: 'سعر بيع USD',
    sourceLabel: 'USD يخرج من',
    destinationLabel: 'LYD يدخل إلى',
    sourceQuestion: 'من أين خرج USD؟',
    destinationQuestion: 'أين دخل LYD؟',
    routeTitle: 'اتجاه البيع',
  },
  [MOVEMENT_TYPES.USD_PURCHASE]: {
    amountLabel: 'كم LYD دفعت؟',
    currency: CURRENCIES.DINAR,
    currencyText: 'LYD',
    currencyLocked: true,
    needsDestination: true,
    needsRate: true,
    rateLabel: 'سعر شراء USD',
    sourceLabel: 'LYD يخرج من',
    destinationLabel: 'USD يدخل إلى',
    sourceQuestion: 'من أين خرج LYD؟',
    destinationQuestion: 'أين دخل USD؟',
  ...
  [MOVEMENT_TYPES.EXTERNAL_INCOME]: {
    ...
    destinationQuestion: 'أين دخلت الفلوس؟',
    routeTitle: 'الدخل',
    noteLabel: 'مصدر الدخل',
    notePlaceholder: 'راتب، إيجار، أو وصف مختصر',
  },
